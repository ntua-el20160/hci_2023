import 'models/vote_for_usersone_model.dart';
...
import 'provider/vote_for_usersone_provider.dart';

class VoteForUsersoneScreen extends StatefulWidget {
  const VoteForUsersoneScreen({Key? key})
      : super(
          key: key,
        );

  @override
  VoteForUsersoneScreenState createState() => VoteForUsersoneScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => VoteForUsersoneProvider(),
      child: VoteForUsersoneScreen(),
    );
  }
}

class VoteForUsersoneScreenState extends State<VoteForUsersoneScreen> {
